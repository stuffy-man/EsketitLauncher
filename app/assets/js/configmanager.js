...
const dataPath = path.join(sysRoot, '.esketitlauncher')
...
/**
 * Добавить офлайн («пиратский») аккаунт. Пароль/валидация не требуются —
 * UUID выводится из ника так же, как в ванильном offline-режиме.
 *
 * @param {string} uuid UUID (без дефисов), рассчитанный из ника.
 * @param {string} username Ник игрока.
 * @returns {Object} Созданный объект аккаунта.
 */
